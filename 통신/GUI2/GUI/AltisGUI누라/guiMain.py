...
class guiMain(QMainWindow):
    ...
    def drawGraphs(self):
        if self.com.isOpen():
            try:
                data_table = self.com.getData()
                print(f"drawGraphs data_table: {data_table}")  # 디버그 출력
                ...
                print(f"drawGraphs ValueError: {e}")

    def drawGraphic(self):
        if self.com.isOpen():
            try:
                data_table = self.com.getData()
                print(f"drawGraphic data_table: {data_table}")  # 디버그 출력
                ...
                print(f"drawGraphic ValueError: {e}")

    def drawtext(self):
        if self.com.isOpen():
            try:
                data_table = self.com.getData()
                print(f"drawtext data_table: {data_table}")  # 디버그 출력
